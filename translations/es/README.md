...
Tu entorno de desarrollo está listo para que pueda comenzar. Basado en nuestra [Plantilla de JavaScript (React) con Codespace](https://github.com/ManupriyaNagar), esto es lo que ya está configurado y listo para su uso:
...
1. Crea un repositorio a partir de esta plantilla. Usa este [link para crear el repositorio](https://github.com/ManupriyaNagar). Selecciona el propietario del repositorio, proporciona un nombre, una descripción si lo deseas y selecciona si tu nuevo repositorio será público o privado.
...
const siteProps = {
  ...
  email: "manupriyanagar2@gmail.com",
  gitHub: "Manupriya Nagar",
  instagram: "Mishka",
  linkedIn: "Manupriya Nagar",
  medium: "",
  twitter: "Manupriya",
  youTube: "Manupriya",
};
...
El proyecto incluye la configuración necesaria para implementar **gratis** en [Azure Static Web Apps](https://azure.microsoft.com/products/app-service/static/?WT.mc_id=academic-79839-sagibbon) _**o**_ [GitHub Pages](https://github.com/ManupriyaNagar)</a>. Las instrucciones para ambas se encuentran a continuación:
...
[GitHub Pages](https://github.com/ManupriyaNagar) te permite alojar sitios web directamente desde tu repositorio de GitHub. Este proyecto ya está configurado para que puedas subir tu portafolio en GitHub Pages con muy pocos pasos.
